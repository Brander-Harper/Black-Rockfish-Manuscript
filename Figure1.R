...
points(KAT$Long5, KAT$Lat5, pch = 22, col = "black", bg = "red", cex=2)
...
points(KAT$Long4, KAT$Lat4, pch = 24, col = "black", bg = "green", cex=1)
points(KAT$Long6, KAT$Lat6, pch = 22, col = "black", bg = "yellow", cex=1)
lines(KAT$Long6, KAT$Lat6, col = "yellow")
legend("bottomright",legend=c("Cape Falcon Fish", "Cascade Head Fish","Cape Perpetua Fish","Redfish Rocks Fish", "Reserves", "NP range", "Newport", "Cape Foulweather"),
       col = c("purple", "pink", "blue", "green", "red", "yellow","orange", "black"), cex=1, pch = 20)
